...
static PyObject *
mimic_CalculateEnergy(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_ParseTuple(args, "iOiO:mimic", &nB, &B, &nI, &I))
    return NULL;
...
static PyObject *
mimic_ReadDomainData(PyObject *self, PyObject *args)
{
    int argc = PyTuple_GET_SIZE(args);
    ...
    int ReadFromStats;
    if (!PyArg_ParseTuple(args, "sssiOO:mimic", &cname, &gname, &dname, &ReadFromStats,&py_comm,&py_comm_i))
    return NULL;
...
static PyObject *
mimic_Partition(PyObject *self, PyObject *args)
{
    int argc = PyTuple_GET_SIZE(args);
    ...
    const char* vname;
    int ReadFromStats;
    if (!PyArg_ParseTuple(args, "sssisOO:mimic", &cname, &gname, &dname, &ReadFromStats,&vname,&py_comm,&py_comm_i))
    return NULL;
...
static PyObject *
mimic_ReconstructdUdXi(PyObject *self, PyObject *args)
{
    int argc = PyTuple_GET_SIZE(args);
    ...
    PyObject* py_Ustate;
    PyObject* py_ghost;
    if (!PyArg_ParseTuple(args, "OOOO:mimic", &py_part, &py_Ustate, &py_comm, &py_comm_i))
      return NULL;
...
static PyObject *
mimic_ReconstructGradient_LSQ(PyObject *self, PyObject *args)
{
  int argc = PyTuple_GET_SIZE(args);
...
static struct PyMethodDef methods[] = {
  {"CalculateEnergy", (PyCFunction)mimic_CalculateEnergy, METH_VARARGS, NULL},
  {"ReconstructGradient_LSQ", (PyCFunction)mimic_ReconstructGradient_LSQ, METH_VARARGS, NULL},
  {"ReadDomainData", (PyCFunction)mimic_ReadDomainData, METH_VARARGS, NULL},
  {"Partition", (PyCFunction)mimic_Partition, METH_VARARGS, NULL},
  {"GradU", (PyCFunction)mimic_ReconstructdUdXi, METH_VARARGS, NULL},
