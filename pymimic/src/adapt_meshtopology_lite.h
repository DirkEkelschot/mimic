...
#ifndef ADAPT_MESHTOPOLOGY_LITE_H
#define ADAPT_MESHTOPOLOGY_LITE_H

using namespace std;

struct Mesh_Topology_BL_Lite{
    int Nprisms;
...
class Mesh_Topology_Lite {
    public:
        Mesh_Topology_Lite(){};
        Mesh_Topology_Lite(Partition* Pa, MPI_Comm comm);
        ~Mesh_Topology_Lite();
        ...
        Mesh_Topology_BL_Lite* getBLMeshTopology();
    ...
    private:
        ...
        std::map<int,std::vector<int> > BLlayers; 
        Mesh_Topology_BL_Lite* mesh_topo_bl;
