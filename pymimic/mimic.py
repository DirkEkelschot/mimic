...
def main():
  ...
  #mesh_read = mimic.ReadDomainData("conn.h5","grid.h5","data.h5",0,comm,comm_info);

  mesh_part = mimic.Partition("conn.h5","grid.h5","data.h5",0,"Mach",comm,comm_info);
  ...
  #dUdXi = mimic.GradU(mesh_part,Ustate_part,comm,comm_info);#   -> {key=El_globID,   value = tuple of [dUdXi,dUdYi,dUdZi]}
