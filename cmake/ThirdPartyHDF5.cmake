...
OPTION(THIRDPARTY_BUILD_HDF5
        "Build HDF5 library from ThirdParty." ${BUILD_HDF5})
...
IF (THIRDPARTY_BUILD_HDF5)
        ...
        #THIRDPARTY_LIBRARY(HDF5_LIBRARY SHARED hdf5
        #    DESCRIPTION "HDF5 library shared")
        SET(HDF5_LIBRARY ${TPDIST}/lib/libhdf5${LIB_EXT} CACHE FILEPATH
            "HDF5 lib directory" FORCE)
        SET(HDF5_HL_LIBRARY ${TPDIST}/lib/libhdf5_hl${LIB_EXT} CACHE FILEPATH
            "HDF5 lib directory" FORCE)
...
ADD_DEPENDENCIES(hdf5-1_14_3 zlib-1.3.1)

#ADD_DEPENDENCIES(mimic hdf5-1_14_3)
